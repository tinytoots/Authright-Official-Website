      ...
      <div className="main-content">
        <ScrollTop>
          <Switch>
            ...
            <Route path="/1" component={CaseHsbc} />
            <Route path="/2" component={CaseHomeDepot} />
            <Route path="/3" component={CaseMohawk} />
            <Route path="/4" component={CaseToyota} />
            <Route path="/5" component={CaseBlue} />
            <Route path="/6" component={CaseEquifax} />
            <Route path="/7" component={CasePearson} />
            <Route path="/8" component={CaseDeloitte} />
            ...
            <Route
              path="/services/iam/managed-services"
              component={ManagedService}
            />
            <Route
              path="/services/iam/education-services"
              component={EducationService}
            />
            <Route
              path="/services/iam/strategic-talent-services"
              component={StrategicTalentService}
            />

            <Route
              path="/services/iam/professional-services/forgerock-consulting"
              component={ForgerockConsulting}
            />
            <Route
              path="/services/iam/professional-services/forgerock-design-development"
              component={ForgeRockDesignDevelopment}
            />
            <Route
              path="/services/iam/professional-services/forgerock-integration"
              component={ForgerockIntegration}
            />
            <Route
              path="/services/iam/professional-services/forgerock-support-and-maintenance"
              component={ForgerockSupport}
            />
            <Route
              path="/services/iam/professional-services/pingidentity-consulting"
              component={PingConsulting}
            />
            <Route
              path="/services/iam/professional-services/pingidentity-design-development"
              component={PingDesignDevelopment}
            />
            <Route
              path="/services/iam/professional-services/pingidentity-integration"
              component={PingIntegration}
            />
            <Route
              path="/services/iam/professional-services/pingidentity-support-and-maintenance"
              component={PingSupport}
            />
            <Route
              path="/services/iam/professional-services"
