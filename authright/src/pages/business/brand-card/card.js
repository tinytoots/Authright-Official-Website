    ...
    render() {
        return (
            <div className='card-bg'>
                <div className="card-grid-title">We are committed to providing reliable and efficient</div>
                <div className="card-grid-title2">IAM and Full Stack services in different industrial fields </div>
                {/* <h1>This is card</h1> */}
                <Row gutter={[10, 10]}>
