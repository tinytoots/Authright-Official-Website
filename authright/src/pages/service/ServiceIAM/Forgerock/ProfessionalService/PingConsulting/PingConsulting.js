...
export default class PingConsulting extends Component {
    render() {
        return (
            <div className='solution-IAM-bg' style={{backgroundColor: 'white'}}>
                <div className='inner'>
                    ...
                    <div className='solution-forgerock-title'>
                        PingIdentity Consulting
                    </div>
                    <div className='managedService-intro2'>
                        Our PingIdentity consultants integrate your enterprise applications with simple, secured, centralized & immediate identity access management.
                    </div>
