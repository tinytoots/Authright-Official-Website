          ...
          <Row gutter="10">
              ...
              <div className="card-customersComments">
                <div className="content-customersComments">
                  ...
                  <div className="comment-paragraph">
                    <p>
                      "I would bring the Authright team to any ForgeRock
                      customers for their exceptional ForgeRock services."
                    </p>
                  </div>
            ...
            <Col xs={12} sm={12} md={6} lg={6} xl={6}>
              <div className="card-customersComments">
                <div className="content-customersComments">
                  <img
                    className="comments-logo-equifax"
                    src={Equifax}
                    alt="logo"
                  />
                  <br />
                  ...
                  <div className="comment-paragraph">
                    <p className="equifax-comments-scope">
                      “Great team! Authright is helping us build a more
                      trustable and stable IAM platform.”
                    </p>
                  </div>
                </div>
              </div>
            ...
            <Col xs={12} sm={12} md={6} lg={6} xl={6}>
              <div className="card-customersComments">
                <div className="content-customersComments">
                  <img
                    className="comments-logo-mohawk"
                    src={Mohawk}
                    alt="logo"
                  />
                  <br />
